...
import { useCallback, useEffect, useState } from "react"; // Importation des hooks useMemo et useState de React
...
const defaultshopItems : ShopItemType[] =[
  { 
    ...
    cps: 100, // Cookies générés par seconde
    total : 0,
  },
];
...
export default function Home() {
  ...
  return (
    <div className="h-screen w-screen flex"> {/* Conteneur principal avec une hauteur et largeur complètes */}
      <div className="left w-1/4 bg-green-500 flex flex col item-center"> {/* Section gauche avec une largeur de 25% et fond vert */}
        <CookieZone 
      ...
      <div className="center flex-1 bg-red-500"> {/* Section centrale prenant le reste de l'espace avec un fond rouge */}
